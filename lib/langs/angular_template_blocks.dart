...
/// TextMate grammar for `angular-template-blocks` (scope `template.blocks.ng`).
final angularTemplateBlocks = BundledLanguage(
  id: 'angular-template-blocks',
  scopeName: 'template.blocks.ng',
  json: _json, embeddedLanguages: () => [angularExpression, angularTemplate],
);
