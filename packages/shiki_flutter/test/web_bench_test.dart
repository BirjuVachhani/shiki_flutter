...
void main() {
  test('web tokenization throughput (Dart / GitHub Dark)', () {
    ...
    buf.writeln('size   lines   fast-path ms   interpreter ms   speedup   lines/s(fast)');
    for (final size in CorpusSize.values) {
      ...
      buf.writeln('${size.label.padRight(5)}  '
